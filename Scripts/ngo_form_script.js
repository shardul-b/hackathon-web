...
const displayPosition = (position) => {
  elementSelector('#latitude').value = position.coords.latitude;
  elementSelector('#longitude').value = position.coords.longitude;
};
...
elementSelector('#submit').addEventListener('click', () => {
  let detailsObj = {};
  let userInputRef = elementSelector('.ngoInput', true);
  ...
  fetch('url', {
    ...
    .then((data) => {
      //data
      //change location href to the page you want the user to take on after this
